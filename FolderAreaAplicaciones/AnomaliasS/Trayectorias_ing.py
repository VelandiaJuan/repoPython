...
# =============================================================================
path1 = 'dinagramasTrayectorias.xls'
Trayectorias = LeerExcel(path1, 0,0)
TrayectoriasC = vec_desc (Trayectorias.posicionF, Trayectorias.cargaF)

xd = Class_Dyna1(TrayectoriasC)
V1 = xd[0]
V2 = xd[1]

Trayectorias1 = LeerExcel(path1, 1,0)
TrayectoriasC1 = vec_desc (Trayectorias1.posicionF, Trayectorias1.cargaF)

xd1 = Class_Dyna1(TrayectoriasC1)
V3 = xd1[0]
V4 = xd1[1]

Trayectorias2 = LeerExcel(path1, 2,0)
TrayectoriasC2 = vec_desc (Trayectorias2.posicionF, Trayectorias2.cargaF)

xd2 = Class_Dyna1(TrayectoriasC2)
V5 = xd2[0]
V6 = xd2[1]

Trayectorias3 = LeerExcel(path1, 3,0)
TrayectoriasC3 = vec_desc (Trayectorias3.posicionF, Trayectorias3.cargaF)

xd3 = Class_Dyna1(TrayectoriasC3)
V7 = xd3[0]
V8 = xd3[1]

trayectoria = [(V1,V3,V5,V7), (V2,V4,V6,V8)]
...
plt.subplot(2, 2, 1)
plt.title("Transition from Average Dynagram \nto standardized Fluid Pound", **csfont)
plt.xlabel("Standard position", **csfont)
plt.ylabel("Standardized load", **csfont)
plt.plot (Trayectorias.posicionF, Trayectorias.cargaF)
plt.plot (Trayectorias1.posicionF, Trayectorias1.cargaF)
plt.plot (Trayectorias2.posicionF, Trayectorias2.cargaF)
plt.plot (Trayectorias3.posicionF, Trayectorias3.cargaF)
...
for i in range (0, 3):
    if Aux10 != 1:
        if V_dist_ord[i][0]<Radio:
            print('Se tiene un porcentaje de certeza del ', round(certeza[i],1) ,'% de ser de la clase ', int(V_dist_ord[i][1]), matriz1[int(V_dist_ord[i][1])], '.')
...
plt.subplot(2, 2, 2)
plt.title ("Knowledge base", **csfont)
for i in range (0,len (clasesanomalias)):
    # if i != 19:
...
plt.plot (trayectoria[0], trayectoria[1], linestyle='--', markersize= 7, color="blue")
plt.plot (V1,V2, markersize = 4, marker = "o", color = "yellow")
plt.plot (V7, V8, markersize= 7, marker="D", color="black")
plt.annotate('DP', (V7*1.005, V8*1.005), fontsize=7)
plt.plot(x, y, linestyle='--',color="blue")
# plt.legend(matriz3, bbox_to_anchor=(1.05, 1.0), loc='upper left', fontsize=7, **csfont)
plt.show()